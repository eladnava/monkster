...
Monkster.prototype.wrapMethod = function (collection, originalMethod) {
    ...
    return function newQueryMethod() {
        // Try counter
        var tries = 0;
        ...
        return new Promise(function (resolve, reject) {
            ...
            executeQuery(collection, originalMethod, config, tries, originalArgs, calling, resolve, reject);
        });
    };
};

function executeQuery(collection, originalMethod, config, tries, originalArgs, calling, resolve, reject) {
    ...
    args.push(function (err, result) {
        ...
        if (err) {
            ...
            if (tries <= config.maxTries) {
                ...
                return setTimeout(function() { executeQuery.apply(this, executeArgs) }, config.retryInterval);
            }
